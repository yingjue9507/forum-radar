...
def main(page: ft.Page):
    # === 📱 手机模拟设置 (电脑预览专用) ===
    page.window.width = 390  # 模拟 iPhone/常见安卓宽度
    page.window.height = 844  # 模拟手机高度
    page.window.always_on_top = True  # 让窗口保持在最前方便调试
    ...
    search_keyword = ft.TextField(
        hint_text="输入关键词...",
        height=45, text_size=14, expand=True,
        bgcolor=ft.Colors.WHITE, border_radius=8
    )
